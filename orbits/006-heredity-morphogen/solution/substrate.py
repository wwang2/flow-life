#!/usr/bin/env python3
"""
Heredity Morphogen Flow-Lenia Substrate -- Orbit 006
=====================================================
...
class HeredityMorphogenSubstrate(BaseFlowLenia):
    ...
    def get_default_params(self) -> dict:
        return {
            ...
            # -- Spot printing (NEW -- light texture for heredity) --
            "spot_print_strength": 0.04,    # Gentle enough to not disrupt fission
