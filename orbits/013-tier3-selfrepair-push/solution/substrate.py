...
class HeredityMorphogenSubstrate(BaseFlowLenia):
    ...
    def get_default_params(self) -> dict:
        return {
            ...
            # -- Morphogen coupling (orbit 013: stronger for self-repair) --
            "morph_coupling": 0.15,          # was 0.08; stronger RD→mass coupling = better pattern memory
            "morph_threshold": 0.4,
            "morph_seed_strength": 0.03,
            "flow_gate_strength": 0.05,
            # -- Spot printing (same as orbit 011) --
            "spot_print_strength": 0.04,
            "spot_print_threshold": 0.5,
            # -- Uncapped growth (orbit 013: tighter mass control) --
            "soft_drift_threshold": 0.08,    # was 0.15; tighter homeostasis for better tier3
            "mass_ceiling": 2.8,
        }
    ...
    def apply_growth(self, state, flow, params):
        ...
        # Very gentle (0.04) to not disrupt orbit 005 fission mechanics
